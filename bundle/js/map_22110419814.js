...
const orthoCenter = [81.6890256711, 21.2518054063];
...
function initializeMap() {
  ...
  map.on('load', () => {
    ...
    map.addSource('orthoTileset', {
      type: 'raster',
      url: 'mapbox://rayapati49.3hvef7e5',
    });
    map.addLayer({
...
function loadGeoJSONLayers() {
  axios.get('/bundle/assets/22110419814_features.geojson').then((response) => {
...
async function loadGeoJSONMarkers() {
  try {
    const response = await axios.get('/bundle/assets/22110419814_spaces.geojson');

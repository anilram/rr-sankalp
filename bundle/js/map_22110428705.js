...
const orthoCenter = [81.6566905262, 21.2641145552];
...
function initializeMap() {
  ...
  map.on('load', () => {
    ...
    map.addSource('orthoTileset', {
      type: 'raster',
      url: 'mapbox://rayapati49.cq8xht4g',
    });
    map.addLayer({
...
function loadGeoJSONLayers() {
  axios.get('/bundle/assets/22110428705_features.geojson').then((response) => {
...
async function loadGeoJSONMarkers() {
  try {
    const response = await axios.get('/bundle/assets/22110428705_spaces.geojson');
...
function getSubButtonsForFloor(floor) {
  const subButtons = {
    ...
    'Block 4 Floor 1': [
      ...
      { name: 'Waiting Hall', url: 'https://my.matterport.com/show/?m=p2zBEUYzuFn&cloudEdit=1&play=1&qs=1&ss=2&sr=81.656806414043714,21.264209283743366' },
      { name: 'Anganvadi', url: 'https://my.matterport.com/show/?m=p2zBEUYzuFn&cloudEdit=1&play=1&qs=1&ss=2&sr=81.656854044166508,21.264197786817174' }
    ]
  };

...
function initializeMap() {
  ...
  map.on('load', () => {
    map.addSource('local-tiles', {
        type: 'raster',
        tiles: ['http://localhost:8080/data/22110403505/{z}/{x}/{y}.png'],
        tileSize: 256
    });
...
function getSubButtonsForFloor(floor) {
  const subButtons = {
    'Block1 Floor1': [
      ...
      { name: 'Boys Toilets', url: 'https://my.matterport.com/show/?m=p2zBEUYzuFn&cloudEdit=1&play=1&qs=1&ss=2&sr=-1.91,-1.43' },
      { name: 'Girls Toilets', url: 'https://my.matterport.com/show/?m=p2zBEUYzuFn&cloudEdit=1&play=1&qs=1&ss=2&sr=-1.91,-1.43' }
    ],
    'Block2 Floor1': [

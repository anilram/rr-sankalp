...
function loadGeoJSONLayers() {
  axios.get('/bundle/assets/22110403505_features.geojson').then((response) => {
...
async function loadGeoJSONMarkers() {
  try {
    const response = await axios.get('/bundle/assets/22110403505_spaces.geojson');
...
function getSubButtonsForFloor(floor) {
  const subButtons = {
    ...
    'Block2 Floor1': [
      { name: 'Staff Room', url: 'https://my.matterport.com/show/?m=KKhZbDVzoJH&cloudEdit=1&play=1&qs=1&ss=3&sr=-3.14' },
      { name: 'Class 3A', url: 'https://my.matterport.com/show/?m=KKhZbDVzoJH&cloudEdit=1&play=1&qs=1&ss=3&sr=-3.14'},
      { name: 'Class 1A', url: 'https://my.matterport.com/show/?m=92fPfxkdDWu&cloudEdit=1&play=1&qs=1&ss=4&sr=-2.42,-1.175' },
      { name: 'Class 5A', url:'https://my.matterport.com/show/?m=92fPfxkdDWu&cloudEdit=1&play=1&qs=1&ss=4&sr=-2.42,-1.175' },
      { name: 'Toilets2', url: 'https://my.matterport.com/show/?m=p2zBEUYzuFn&cloudEdit=1&play=1&qs=1&ss=2&sr=-1.91,-1.43' },
      { name: 'Class 4A', url: 'https://my.matterport.com/show/?m=KKhZbDVzoJH&cloudEdit=1&play=1&qs=1&ss=3&sr=-3.14' }
    ]
  };
...
function getDeepLinkForArea(area) {
  const deepLinks = {
    'Toilets': 'https://my.matterport.com/show/?m=p2zBEUYzuFn&cloudEdit=1&play=1&qs=1&ss=2&sr=-1.91,-1.43',
    'Toilets2': 'https://my.matterport.com/show/?m=p2zBEUYzuFn&cloudEdit=1&play=1&qs=1&ss=2&sr=-1.91,-1.43',
